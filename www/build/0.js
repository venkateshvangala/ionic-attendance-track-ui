...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_geolocation__ = __webpack_require__(436);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_attendance_service__ = __webpack_require__(438);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_geolocation__ = __webpack_require__(436);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var HomePage = /** @class */ (function () {
    ...
    HomePage.prototype.onGeoLocationSuccess = function (geo) {
        ...
        if (this.isPresent) {
            ...
            this.attendanceService.logInAttendance(postData).subscribe(function (response) {
                _this.fetchLogInInfo();
            }, function (error) { return console.log(error); });
        }
        else {
            postData["logOutLat"] = latitude;
            postData["logOutLag"] = longitude;
            this.attendanceService.logOutAttendance(postData).subscribe(function (response) {
                _this.fetchLogInInfo();
            }, function (error) { return console.log(error); });
        }
    };
    HomePage.prototype.fetchLogInInfo = function () {
        var _this = this;
        this.attendanceService.fetchLogInInfo().subscribe(function (response) {
            _this.logInInfoList = response;
        }, function (error) { return console.log(error); });
    };
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"/Users/venkateshv/projects/mobile-apps/attendance-tracking/src/pages/home/home.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      Attendance Tracking\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <ion-item>\n    <ion-label> Log In</ion-label>\n    <ion-toggle checked="{{isPresent}}" (ionChange)="toggleAttendance()"></ion-toggle>\n  </ion-item>\n\n  <ion-item>\n    <ion-label> Log In Time</ion-label>\n    <ion-label> Log Out Time</ion-label>\n  </ion-item>\n  <ion-item *ngFor="let item of logInInfoList;">\n      <ion-label> {{item.logIn | date: "dd/MM/yyyy hh:mm:ss a"}} </ion-label>\n      <ion-label> {{item.logOut | date: "dd/MM/yyyy hh:mm:ss a"}}  </ion-label>\n    </ion-item>\n</ion-content>'/*ion-inline-end:"/Users/venkateshv/projects/mobile-apps/attendance-tracking/src/pages/home/home.html"*/
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_common_http__ = __webpack_require__(262);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__app_urls__ = __webpack_require__(431);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__api_service__ = __webpack_require__(432);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AttendanceService = /** @class */ (function () {
    function AttendanceService(httpClient, apiService) {
        this.httpClient = httpClient;
        this.apiService = apiService;
    }
    AttendanceService.prototype.logInAttendance = function (data) {
        return this.apiService.post(__WEBPACK_IMPORTED_MODULE_2__app_urls__["a" /* URLs */]["logInAttendance"]["url"], data);
    };
    AttendanceService.prototype.logOutAttendance = function (data) {
        return this.apiService.post(__WEBPACK_IMPORTED_MODULE_2__app_urls__["a" /* URLs */]["logOutAttendance"]["url"], data);
    };
    AttendanceService.prototype.fetchLogInInfo = function () {
        return this.apiService.get(__WEBPACK_IMPORTED_MODULE_2__app_urls__["a" /* URLs */]["fetchLogInInfo"]["url"]);
    };
