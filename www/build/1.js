...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__register__ = __webpack_require__(440);
...
var urls = {
    ...
    "logInAttendance": {
        "url": "attendance/log_in_attendance"
    },
    "logOutAttendance": {
        "url": "attendance/log_out_attendance"
    },
    "fetchLogInInfo": {
        "url": "attendance/fetch_log_in_info"
    }
};
var URLs = urls;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_underscore__ = __webpack_require__(433);
...
var ApiService = /** @class */ (function () {
    ...
    ApiService.prototype.post = function (endpoint, body, reqOpts) {
        return this.http.post(this.url + '/' + endpoint, body, __WEBPACK_IMPORTED_MODULE_2_underscore__["isEmpty"](reqOpts) ? { headers: this.getHeaders() } : reqOpts);
    };
    ApiService.prototype.put = function (endpoint, body, reqOpts) {
        return this.http.put(this.url + '/' + endpoint, body, __WEBPACK_IMPORTED_MODULE_2_underscore__["isEmpty"](reqOpts) ? { headers: this.getHeaders() } : reqOpts);
    };
    ApiService.prototype.delete = function (endpoint, reqOpts) {
        return this.http.delete(this.url + '/' + endpoint, __WEBPACK_IMPORTED_MODULE_2_underscore__["isEmpty"](reqOpts) ? { headers: this.getHeaders() } : reqOpts);
    };
    ApiService.prototype.patch = function (endpoint, body, reqOpts) {
        return this.http.patch(this.url + '/' + endpoint, body, __WEBPACK_IMPORTED_MODULE_2_underscore__["isEmpty"](reqOpts) ? { headers: this.getHeaders() } : reqOpts);
    };
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(263), __webpack_require__(434)(module)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__app_urls__ = __webpack_require__(431);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__api_service__ = __webpack_require__(432);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.signup = function (user) {
        return this.apiService.post(__WEBPACK_IMPORTED_MODULE_1__app_urls__["a" /* URLs */]["signup"]["url"], user);
    };
    AuthService.prototype.signin = function (account) {
        return this.apiService.post(__WEBPACK_IMPORTED_MODULE_1__app_urls__["a" /* URLs */]["signin"]["url"], account, { responseType: 'text' });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_auth_service__ = __webpack_require__(435);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var RegisterPage = /** @class */ (function () {
    function RegisterPage(navCtrl, device, authService) {
    ...
    RegisterPage.prototype.signup = function () {
        ...
        this.authService.signup(this.account).subscribe(function (response) {
    ...
    RegisterPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'register-home',template:/*ion-inline-start:"/Users/venkateshv/projects/mobile-apps/attendance-tracking/src/pages/register/register.html"*/'<ion-content class="login-content" padding>\n  <ion-row class="logo-row">\n    <ion-col></ion-col>\n    <ion-col width-67>\n      <img src="http://placehold.it/300x200" />\n    </ion-col>\n    <ion-col></ion-col>\n  </ion-row>\n  <div class="login-box">\n\n    <form>\n      <ion-row>\n        <ion-col>\n          <ion-list inset>\n            <ion-item>\n              <ion-input type="text" placeholder="Email" name="email" [(ngModel)]="account.emailId" required></ion-input>\n            </ion-item>\n            <ion-item>\n              <ion-input type="text" placeholder="First Name" name="firstName" [(ngModel)]="account.firstName" required></ion-input>\n            </ion-item>\n            <ion-item>\n              <ion-input type="text" placeholder="Last Name" name="lastName" [(ngModel)]="account.lastName" required></ion-input>\n            </ion-item>\n            <ion-item>\n              <ion-input type="text" placeholder="Phone" name="phone" [(ngModel)]="account.phone" required></ion-input>\n            </ion-item>\n            <ion-item>\n              <ion-input type="password" placeholder="Password" name="password" [(ngModel)]="account.password" required></ion-input>\n            </ion-item>\n\n          </ion-list>\n        </ion-col>\n      </ion-row>\n\n      <ion-row>\n        <ion-col class="signup-col">\n          <button ion-button class="submit-btn" full (click)="signup()">Register</button>\n        </ion-col>\n      </ion-row>\n\n    </form>\n  </div>\n</ion-content>'/*ion-inline-end:"/Users/venkateshv/projects/mobile-apps/attendance-tracking/src/pages/register/register.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */], __WEBPACK_IMPORTED_MODULE_2__ionic_native_device__["a" /* Device */], __WEBPACK_IMPORTED_MODULE_3__services_auth_service__["a" /* AuthService */]])
    ], RegisterPage);
    return RegisterPage;
}());
