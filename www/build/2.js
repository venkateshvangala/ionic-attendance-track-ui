...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__login__ = __webpack_require__(439);
...
var LoginPage = /** @class */ (function () {
    function LoginPage(navCtrl, device, authService) {
    ...
    LoginPage.prototype.login = function () {
        var _this = this;
        this.authService.signin(this["account"]).subscribe(function (response) {
            localStorage.setItem("user-token", "Bearer " + response);
            _this.navCtrl.setRoot('HomePage');
        }, function (error) { console.log("error in login: " + error); });
    };
